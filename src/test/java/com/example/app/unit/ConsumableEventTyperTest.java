...
import com.example.app.conf.FacadeIT;
import com.example.app.endpoint.event.consumer.model.ConsumableEvent;
import com.example.app.endpoint.event.consumer.model.ConsumableEventTyper;
import com.example.app.endpoint.event.consumer.model.TypedEvent;
import com.example.app.endpoint.event.model.UuidCreated;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent = new TypedEvent("com.example.app.endpoint.event.model.UuidCreated", payload);
  ...
  void to_acknowledgeable_typed_event_ko() throws JsonProcessingException {
    ...
    var validTypedEvent =
        new TypedEvent("com.example.app.endpoint.event.model.UuidCreated", payload);
